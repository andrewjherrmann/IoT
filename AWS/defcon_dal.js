...
function updateRoomStatus(params, newLevel){
	...
	console.log('before update:', JSON.stringify(params, null, 2));
	console.log('before update item:', JSON.stringify(item, null, 2));
...
switch (event.operation) {
	...
	case 'instant_death':
		...
		dbdoc.get(params, function(err, data) {
			if (!err && !isEmpty(data)) {
				console.log('We found it:', JSON.stringify(data, null, 2));
				params.Item = data.Item;
				var data = updateRoomStatus(params, 1);
				done(null, data);
			} 
		});
		break;
